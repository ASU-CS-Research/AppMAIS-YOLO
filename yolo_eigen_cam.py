...
if __name__ == '__main__':
    ...
    # print(dir(ultralytics_model.ultralytics_model))
    # # print(ultralytics_model.ultralytics_model.info)
    # # print(ultralytics_model.ultralytics_model.named_parameters)
    # print(ultralytics_model.ultralytics_model.yaml)
    # # summary(ultralytics_model.ultralytics_model, (3, 640, 480))
    # exit()
    pytorch_sequential_model = ultralytics_model.model.__dict__["_modules"]["ultralytics_model"]
    pytorch_yaml_config = ultralytics_model.model.__dict__["yaml"]
    # classes = ultralytics_model.ultralytics_model.__dict__["names"]
    classes = [0, 1]
    model = PytorchYOLOV8(pytorch_sequential_model, pytorch_yaml_config, classes, conf_thresh=0.64)
    # ultralytics_model.pprint_yaml()
    model = model.eval()
    ...
    exit()
    # print('Results from the reconstructed pytorch ultralytics_model:')
    # print(results)
    # print(ultralytics_model)
    # print(dir(ultralytics_model))
    # for i, child in enumerate(ultralytics_model.named_children()):
    #     print(i)
    ...
    # print('Results from the ultralytics ultralytics_model:')
