...
# labels = os.listdir("/home/bee/bee-detection/data_appmais_lab/labels")
...
# making the folders
# for hive in hives:
#     data = "/home/bee/bee-detection/data_appmais_lab/data_by_hive"
...
#
# for hive in ["1L", "1R", "2L"]:
#     data_yaml = os.path.abspath(f"/home/olofintuyita/AppMAIS-YOLO/data_by_hive/{hive}/{hive}data.yaml")
